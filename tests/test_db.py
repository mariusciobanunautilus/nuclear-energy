...
def test_source_tier_for_kind_ranks_source_trust():
    ...
    assert source_tier_for_kind(SourceKind.rss, "Canadian Nuclear Safety Commission") == "tier_2_official_document"
    assert source_tier_for_kind(SourceKind.rss, "UK Office for Nuclear Regulation News") == "tier_2_official_document"
    assert source_tier_for_kind(SourceKind.rss, "ASNR Reactor Outages") == "tier_2_official_document"
    assert source_tier_for_kind(SourceKind.rss, "Nuclearelectrica News") == "tier_3_company_statement"
