...
COUNTRY_ALIASES = (
    ...
    CountryAlias("AUS", "Australia", ("australia", "australian")),
    ...
    CountryAlias("EGY", "Egypt", ("egypt", "egyptian")),
    ...
    CountryAlias("IDN", "Indonesia", ("indonesia", "indonesian")),
    ...
    CountryAlias("PHL", "Philippines", ("philippines", "philippine", "filipino")),
    ...
    CountryAlias("TUR", "Turkey", ("turkey", "turkish", "turkiye")),
